 ...
 */
abstract class AbstractProviderInternalFactory<T, P> implements InternalFactory<T> {

  protected final Object source;
  protected ProvisionListenerStackCallback<T> provisionCallback;

  AbstractProviderInternalFactory(Object source) {
    this.source = checkNotNull(source, "source");
  }

  AbstractProviderInternalFactory(
      Object source,
  ...
  protected T provision(
      ...
      throws InternalProvisionException {
    T t = provide(provider, dependency);
  ...
  protected abstract T provide(P provider, Dependency<?> dependency);
}
