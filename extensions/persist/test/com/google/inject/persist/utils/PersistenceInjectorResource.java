...
public class PersistenceInjectorResource extends SuiteAndTestResource implements Injector {
	...
	public PersistenceInjectorResource(String unitName, Function<JpaPersistModule, JpaPersistModule> configurer) {
		this(Lifecycle.SUITE, unitName, configurer);
	}

	public PersistenceInjectorResource(Lifecycle lifecycle, String unitName, Function<JpaPersistModule, JpaPersistModule> configurer) {
		super(lifecycle);
