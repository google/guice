...
import static com.google.inject.servlet.jee.ServletTestUtils.newFakeHttpServletRequest;
import static com.google.inject.servlet.jee.ServletTestUtils.newFakeHttpServletResponse;
...
import com.google.inject.servlet.jee.ServletScopes.NullObject;
...
public class ServletTest extends TestCase {
  ...
  public void testGuiceFilterConstructors() throws Exception {
    ...
    try {
      new GuiceFilter().doFilter(request, newFakeHttpServletResponse(), filterChain);
      fail();
    } catch (RuntimeException e) {
      assertSame(servletException, e);
    }
    try {
      injector.getInstance(GuiceFilter.class).doFilter(request, newFakeHttpServletResponse(), filterChain);
      fail();
    } catch (RuntimeException e) {
      assertSame(servletException, e);
    }
