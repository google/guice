...
public class MultipleServletInjectorsTest extends TestCase {
  ...
  public final void testTwoInjectors() {
    ...
    fakeContextOne.setAttribute(eq(GuiceServletContextListener.INJECTOR_NAME), isA(Injector.class));
    expectLastCall().once();

    fakeContextTwo.setAttribute(eq(GuiceServletContextListener.INJECTOR_NAME), isA(Injector.class));
    expectLastCall().once();
