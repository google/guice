...
import static com.google.inject.servlet.jee.ServletScopes.REQUEST;
import static com.google.inject.servlet.jee.ServletScopes.SESSION;
...
final class InternalServletModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(ServletContext.class).toJeeProvider(BackwardsCompatibleServletContextProvider.class);
